...
export default function Sidebar() {
  ...
  return (
    <div className="h-full hidden sm:flex flex-col fixed xl:ml-24 ml-2">
      <nav className="h-full relative xl:space-y-1.5">
        ...
        <div
          ...
          className="bottom-0 hover:bg-white hover:bg-opacity-10 rounded-full cursor-pointer absolute flex justify-center 
        items-center xl:p-3 space-x-3"
        >
          <img
